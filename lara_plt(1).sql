...
--
-- Host: localhost
-- Generation Time: Jun 23, 2020 at 05:09 PM
...
--
-- Table structure for table `app-daily_report`
--
...
CREATE TABLE `app-daily_report` (
  ...
  `report_date_submitted` date DEFAULT NULL,
  `report_folderpath` varchar(255) DEFAULT NULL,
  `report_filecount` int(50) DEFAULT NULL,
  `report_uid` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `app-daily_report`
--

INSERT INTO `app-daily_report` (`id`, `group_uid`, `student_id`, `report_detail`, `report_date`, `report_date_submitted`, `report_folderpath`, `report_filecount`, `report_uid`) VALUES
(43, 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk', '9350', 'sdadsa123', '2020-06-01', '2020-06-21', 'Daily Report/Sayati-9/2020-06-01_2020-06-21 16:25:41', 1, 'PcMxeRZlt69Mo7fL2B7L32FFelLH1Zo7JA3'),
(44, 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk', '9350', 'sads1231', '2020-06-03', '2020-06-21', 'Daily Report/Sayati-9/2020-06-03_2020-06-21 16:25:51', 1, 'uo8SuP8KwyWQK4kp6glRMsKaa0kTENL4YQs'),
(45, 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk', '9350', '2sdads2', '2020-06-20', '2020-06-21', 'Daily Report/Sayati-9/2020-06-20_2020-06-21 16:25:57', 1, 'a4ueBrjVPvyKdnKUafz9GpnIA0eZDZHrAjl'),
(46, 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk', '9350', 'szzx2qweq', '2020-06-21', '2020-06-21', 'Daily Report/Sayati-9/2020-06-21_2020-06-21 17:18:33', 1, 'VaaEVa0ckzra8sLoDZSI62bvHjFIVp56bih'),
(47, 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk', '9350', 'Hevtsh', '2020-06-17', '2020-06-21', 'Daily Report/Sayati-9/2020-06-17_2020-06-21 17:44:08', 1, 'fFY3DMgFeVfQwvxiuFBpY3KFeTNboA0ejw4'),
(48, 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk', '9350', 'sdads231', '2020-06-22', '2020-06-23', 'Daily Report/Sayati-9/2020-06-22_2020-06-23 21-34-27', 4, 'LFospOcRHardMYhqDbOdpilJDtNZ3gGjb2G'),
(49, 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk', '9350', 'dsa123412', '2020-06-04', '2020-06-23', 'Daily Report/Sayati-9/2020-06-04_2020-06-23 21-34-45', 2, '2hw5eDxWQkHDrjIMqblhGDrkwcP84kKfzeW');
...
(2, 5, 'Low Filter Satu123', '9350', 'Laki-Laki', '2017', 'FPTK', 'Elektro', '214798219', 'lpf_student921@lpf.com', 'ahjdsjklghahksshgkac', 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk'),
...
CREATE TABLE `app-faculty_student-group` (
  ...
  `final_report_status` int(255) DEFAULT NULL,
  `final_report_rev_status` int(255) DEFAULT NULL,
  `proker_acc_count` int(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `app-faculty_student-group` (`id`, `group_name`, `group_location`, `member_count`, `member_registered`, `token_registered`, `token`, `unique_id`, `village_name`, `village_center_address`, `village_head_name`, `village_head_phone`, `group_mentor_id`, `babinsa_name`, `babinsa_phone`, `final_report_status`, `final_report_rev_status`, `proker_acc_count`) VALUES
(20, 'Sayati-2', NULL, 11, 1, 1, '2A513D04', 'zf4QOI02siKOfkAvOC65NcTeyyJ9loChpDq', 'Desa Sayati', NULL, NULL, NULL, '6', NULL, NULL, NULL, NULL, NULL),
(21, 'Sayati-9', NULL, 13, 2, 1, '2A515D87', 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk', 'Desa Sayati', 'Bandung', 'Pak Hehe', '09864736723', '6', 'Pak Hola', '2893047327', NULL, NULL, NULL),
(22, 'Sayati152231', NULL, 13, NULL, NULL, NULL, 'IoMHgqWu8qI43d3cR2yUZet8eonPPQ11eBo', 'Desa Bojongsoang', NULL, NULL, NULL, '6', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `app-final_report`
--

CREATE TABLE `app-final_report` (
  `id` int(255) NOT NULL,
  `group_uid` varchar(255) DEFAULT NULL,
  `fr_stat` int(5) DEFAULT NULL,
  `fr_rev_stat` int(5) DEFAULT NULL,
  `fr_filename` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `app-final_report`
--

INSERT INTO `app-final_report` (`id`, `group_uid`, `fr_stat`, `fr_rev_stat`, `fr_filename`) VALUES
(1, 'RdqAeTE3KczB1Z3AdbAWFNFw4Al7tKwGfTk', 1, 1, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `app-proker-list`
--

CREATE TABLE `app-proker-list` (
  `id` int(255) NOT NULL,
  `group_uid` varchar(255) DEFAULT NULL,
  `proker_name` varchar(255) DEFAULT NULL,
  `proker_category` varchar(255) DEFAULT NULL,
  `proker_detail` text DEFAULT NULL,
  `proker_filename` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `app-proker-propose_pending`
--

CREATE TABLE `app-proker-propose_pending` (
  `id` int(255) NOT NULL,
  `group_uid` varchar(255) DEFAULT NULL,
  `proker_name` varchar(255) DEFAULT NULL,
  `proker_category` varchar(255) DEFAULT NULL,
  `proker_detail` text DEFAULT NULL,
  `proker_filename` varchar(255) DEFAULT NULL,
  `proker_uid` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(199, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-18 09:37:52', '2020-06-18 09:37:52', NULL),
(200, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-18 09:37:52', '2020-06-18 09:37:52', NULL),
(201, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/', 'GET', '2020-06-18 11:55:29', '2020-06-18 11:55:29', NULL),
(202, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-19 09:01:56', '2020-06-19 09:01:56', NULL),
(203, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-19 09:01:56', '2020-06-19 09:01:56', NULL),
(204, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-19 22:34:32', '2020-06-19 22:34:32', NULL),
(205, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-19 22:34:32', '2020-06-19 22:34:32', NULL),
(206, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-20 03:29:38', '2020-06-20 03:29:38', NULL),
(207, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-20 03:29:38', '2020-06-20 03:29:38', NULL),
(208, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/', 'GET', '2020-06-20 03:59:55', '2020-06-20 03:59:55', NULL),
(209, 'Logged Out', 'Registered', 5, 'http://127.0.0.1:8000/logout', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/student/proker/daily-report', 'POST', '2020-06-20 04:02:24', '2020-06-20 04:02:24', NULL),
(210, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-20 04:02:35', '2020-06-20 04:02:35', NULL),
(211, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-20 04:02:35', '2020-06-20 04:02:35', NULL),
(212, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/', 'GET', '2020-06-20 04:07:29', '2020-06-20 04:07:29', NULL),
(213, 'Logged Out', 'Registered', 5, 'http://127.0.0.1:8000/logout', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/student/proker/daily-report/add', 'POST', '2020-06-20 04:26:31', '2020-06-20 04:26:31', NULL),
(214, 'Failed Login Attempt', 'Guest', NULL, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-20 04:26:38', '2020-06-20 04:26:38', NULL),
(215, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-20 04:26:41', '2020-06-20 04:26:41', NULL),
(216, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-20 04:26:41', '2020-06-20 04:26:41', NULL),
(217, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/', 'GET', '2020-06-20 06:52:44', '2020-06-20 06:52:44', NULL),
(218, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-20 18:08:00', '2020-06-20 18:08:00', NULL),
(219, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-20 18:08:00', '2020-06-20 18:08:00', NULL),
(220, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-21 01:17:02', '2020-06-21 01:17:02', NULL),
(221, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-21 01:17:02', '2020-06-21 01:17:02', NULL),
(222, 'Logged Out', 'Registered', 5, 'http://127.0.0.1:8000/logout', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/student/proker/final-report', 'POST', '2020-06-21 03:35:18', '2020-06-21 03:35:18', NULL),
(223, 'Logged In', 'Registered', 5, 'http://192.168.100.13:8000/login', '192.168.100.2', 'Mozilla/5.0 (Linux; Android 10; Redmi Note 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.96 Mobile Safari/537.36', 'en-US,en;q=0.9', 'http://192.168.100.13:8000/login', 'POST', '2020-06-21 03:37:47', '2020-06-21 03:37:47', NULL),
(224, 'Viewed home', 'Registered', 5, 'http://192.168.100.13:8000/home', '192.168.100.2', 'Mozilla/5.0 (Linux; Android 10; Redmi Note 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.96 Mobile Safari/537.36', 'en-US,en;q=0.9', 'http://192.168.100.13:8000/login', 'GET', '2020-06-21 03:37:47', '2020-06-21 03:37:47', NULL),
(225, 'Viewed home', 'Registered', 5, 'http://192.168.100.13:8000/home', '192.168.100.2', 'Mozilla/5.0 (Linux; Android 10; Redmi Note 5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.96 Mobile Safari/537.36', 'en-US,en;q=0.9', 'http://192.168.100.13:8000/', 'GET', '2020-06-21 03:43:03', '2020-06-21 03:43:03', NULL),
(226, 'Logged In', 'Registered', 1, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-21 04:45:55', '2020-06-21 04:45:55', NULL),
(227, 'Viewed home', 'Registered', 1, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-21 04:45:55', '2020-06-21 04:45:55', NULL),
(228, 'Viewed active-users', 'Registered', 1, 'http://127.0.0.1:8000/active-users', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/home', 'GET', '2020-06-21 04:46:03', '2020-06-21 04:46:03', NULL),
(229, 'Viewed blocker', 'Registered', 1, 'http://127.0.0.1:8000/blocker', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/active-users', 'GET', '2020-06-21 04:46:15', '2020-06-21 04:46:15', NULL),
(230, 'Viewed users', 'Registered', 1, 'http://127.0.0.1:8000/users', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/roles', 'GET', '2020-06-21 04:46:29', '2020-06-21 04:46:29', NULL),
(231, 'Viewed themes', 'Registered', 1, 'http://127.0.0.1:8000/themes', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/users', 'GET', '2020-06-21 04:46:41', '2020-06-21 04:46:41', NULL),
(232, 'Viewed logs', 'Registered', 1, 'http://127.0.0.1:8000/logs', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/users', 'GET', '2020-06-21 04:47:10', '2020-06-21 04:47:10', NULL),
(233, 'Viewed activity', 'Registered', 1, 'http://127.0.0.1:8000/activity', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/logs', 'GET', '2020-06-21 04:47:16', '2020-06-21 04:47:16', NULL),
(234, 'Viewed phpinfo', 'Registered', 1, 'http://127.0.0.1:8000/phpinfo', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/activity', 'GET', '2020-06-21 04:47:35', '2020-06-21 04:47:35', NULL),
(235, 'Viewed routes', 'Registered', 1, 'http://127.0.0.1:8000/routes', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/phpinfo', 'GET', '2020-06-21 04:47:41', '2020-06-21 04:47:41', NULL),
(236, 'Viewed active-users', 'Registered', 1, 'http://127.0.0.1:8000/active-users', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/routes', 'GET', '2020-06-21 04:47:56', '2020-06-21 04:47:56', NULL),
(237, 'Viewed blocker', 'Registered', 1, 'http://127.0.0.1:8000/blocker', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/active-users', 'GET', '2020-06-21 04:47:59', '2020-06-21 04:47:59', NULL),
(238, 'Viewed blocker/create', 'Registered', 1, 'http://127.0.0.1:8000/blocker/create', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/blocker', 'GET', '2020-06-21 04:48:03', '2020-06-21 04:48:03', NULL),
(239, 'Viewed blocker/5', 'Registered', 1, 'http://127.0.0.1:8000/blocker/5', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/blocker', 'GET', '2020-06-21 04:48:23', '2020-06-21 04:48:23', NULL),
(240, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-22 22:07:33', '2020-06-22 22:07:33', NULL),
(241, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-22 22:07:33', '2020-06-22 22:07:33', NULL),
(242, 'Logged Out', 'Registered', 5, 'http://127.0.0.1:8000/logout', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/student', 'POST', '2020-06-22 22:08:07', '2020-06-22 22:08:07', NULL),
(243, 'Logged In', 'Registered', 6, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-22 22:09:32', '2020-06-22 22:09:32', NULL),
(244, 'Viewed home', 'Registered', 6, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-22 22:09:32', '2020-06-22 22:09:32', NULL),
(245, 'Logged In', 'Registered', 5, 'http://127.0.0.1:8000/login', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'POST', '2020-06-23 07:32:29', '2020-06-23 07:32:29', NULL),
(246, 'Viewed home', 'Registered', 5, 'http://127.0.0.1:8000/home', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Safari/537.36', 'en-US,en;q=0.9', 'http://127.0.0.1:8000/login', 'GET', '2020-06-23 07:32:29', '2020-06-23 07:32:29', NULL);
...
--
-- Indexes for table `app-daily_report`
--
...
--
-- Indexes for table `app-final_report`
--
ALTER TABLE `app-final_report`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `app-proker-list`
--
ALTER TABLE `app-proker-list`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `app-proker-propose_pending`
--
ALTER TABLE `app-proker-propose_pending`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `app-daily_report`
--
ALTER TABLE `app-daily_report`
...
--
-- AUTO_INCREMENT for table `app-final_report`
--
ALTER TABLE `app-final_report`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `app-proker-list`
--
ALTER TABLE `app-proker-list`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `app-proker-propose_pending`
--
ALTER TABLE `app-proker-propose_pending`
